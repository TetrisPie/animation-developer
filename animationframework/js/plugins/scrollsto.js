function ScrollingTo(actor, targetX, targetY, forceX, forceY, triggeredByAction, reactionTargetIndex){
...
Actor.prototype.scrollsTo = function(targetX, targetY, forceX, forceY, triggeredByAction, reactionTargetIndex) {
  triggeredByAction = (typeof triggeredByAction === 'undefined') ? false : triggeredByAction
  var behavior = new ScrollingTo(this, targetX, targetY, forceX, forceY, triggeredByAction, reactionTargetIndex)
